  ...
  roleSections: [
    {
      ...
      insight: {
        ...
        body: "I used Figma to explore early directions, map the core user flows, and define wireframes before moving into implementation. This helped establish the overall structure without over-investing in high-fidelity mockups.\n\nOnce the foundation was in place, I shifted to a more iterative workflow. Rather than polishing static screens, I rapidly explored ideas through working prototypes, using AI-assisted development tools to test interactions and refine the experience in a real environment.\n\nBecause the project was built on a reusable design system—with shared components, typography, spacing, and color tokens—design and development evolved together. This allowed visual decisions to be validated directly in the product, making iteration significantly faster than a traditional handoff process.\n\nInvesting in a reusable design system transformed implementation into an extension of the design process, enabling rapid experimentation without compromising consistency.",
        images: [
          {
            src: photifyFigma,
